...
module.exports = {
    getTickets: async (req,res)=>{
        ...
        try{
            ...
            const ticketsLeft = await Ticket.countDocuments({userId:req.user.id,completed: false})
            res.render('tickets.ejs', {tickets: ticketItems, left: ticketsLeft, user: req.user})
        }catch(err){
            console.log(err)
        }
    },
